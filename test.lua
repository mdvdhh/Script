...
local Button = Tab:Button({
    ...
    Locked = false,
    Callback = function()
    loadstring(game:HttpGet('https://pastefy.app/Xdf2423y/raw'))()
    end
})
...
local themeFolder = ReplicatedStorage:FindFirstChild("CHed_ThemeVals")
if not themeFolder then
    themeFolder = Instance.new("Folder")
    themeFolder.Name = "CHed_ThemeVals"
